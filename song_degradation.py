...
df = pd.read_sql(f"SELECT * from individual_syllable", db.conn)


bird_id = df['birdID'].unique()


df_b70r38 = df[df['birdID'] == 'b70r38']

print(df_b70r38.head(100).to_string())

task_name = df_b70r38['taskName'].unique()

df_pre = df_b70r38[df_b70r38['taskName'] == 'Predeafening']
