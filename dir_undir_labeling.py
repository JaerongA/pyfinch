...
data_path = r'H:\Box\Data\Deafening Project\y44r34\Predeafening\20200707\02'
os.chdir(data_path)
...
for tag in list_dir:
    ...
    for file in list_file:
        ...
        if ext == '.txt':
            ...
            new_file = '_'.join([file[:str.find(file, '(labeling)')], tag.title()]) + file[str.find(file, '(labeling)'):]
            shutil.copyfile(file, os.path.join(data_path, new_file))
        else:
