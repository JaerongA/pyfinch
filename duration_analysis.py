...
for bird in bird_list:
    for task in task_list:
        ...
        # mark each note
        mean_dur = list(zip(note_list, temp_df.groupby(['Note'])['Duration'].mean().to_list())) # [('a', 236.3033654971783), ('b', 46.64262295081962), ('c', 154.57333333333335), ('d', 114.20039483457349)]
